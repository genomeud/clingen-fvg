...
HRDetect_pipeline <- function(data_matrix=NULL,
                              genome.v="hg19",
                              SNV_vcf_files=c(FVG9T="/mnt/vol1/projects/clingen/Somatic/Somatic_SNV/FVG9T.muTect.somatic.snv.vcf"),
                              SNV_tab_files=NULL,
                              SNV_catalogues=NULL,
                              Indels_vcf_files=c(FVG9T="/mnt/vol1/projects/clingen/Somatic/Somatic_INDEL/FVG9T.Strelka.somatic.indel.vcf"),
                              CNV_tab_files=c(FVG9T="/mnt/vol1/projects/clingen/Control-FREEC/cnv_for_HRDetect/cnv_for_HRDetect.txt"),
                              SV_bedpe_files=c(FVG9T="/mnt/vol1/projects/clingen/Somatic/Somatic_SV/HRDetect/FVG9T.delly.somatic.sv.bed"),
                              SV_catalogues=NULL,
